...
public class MainApplication {
    ...
    public static void main(String[] args) {
        ...
        Flux<Persona> personas = Flux.just(
                new Persona("Mariela", "Cúcuta", new String[]{"Calle 2"}, 2500.60),
                new Persona("Carolina", "Bogota", new String[]{"Avenida 6"}, 1500.75),
                new Persona("Juan", "Cartagena", new String[]{"Calle 7"}, 4500.30),
                new Persona("Claudia", "Bucaramanga", new String[]{"Avenida 56"}, -40),
                new Persona("Lorena", "Tunja", new String[]{"Calle 8"}, 20.0),
                new Persona("Camila", "Sogamoso", new String[]{"Avenida 12"}, 5500)
        );

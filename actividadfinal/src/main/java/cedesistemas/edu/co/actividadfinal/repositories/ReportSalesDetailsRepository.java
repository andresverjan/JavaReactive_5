...
public interface ReportSalesDetailsRepository extends ReactiveCrudRepository<ReportSalesDetails, Integer> {
    @Query("""
            SELECT
            ...
            ORDER BY
                ov.fecha_orden;
            """)
    Flux<ReportSalesDetails> findAllByFechaOrdenBetween(String fechaInicial, String fechaFinal);
}
